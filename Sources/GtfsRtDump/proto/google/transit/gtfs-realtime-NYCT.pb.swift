...
// Source: proto/google/transit/gtfs-realtime-NYCT.proto
//
...
struct TransitRealtime_TripReplacementPeriod {
...
struct TransitRealtime_NyctFeedHeader {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct TransitRealtime_NyctTripDescriptor {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension TransitRealtime_NyctTripDescriptor.Direction: CaseIterable {
...
struct TransitRealtime_NyctStopTimeUpdate {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension TransitRealtime_TripReplacementPeriod: @unchecked Sendable {}
extension TransitRealtime_NyctFeedHeader: @unchecked Sendable {}
extension TransitRealtime_NyctTripDescriptor: @unchecked Sendable {}
extension TransitRealtime_NyctTripDescriptor.Direction: @unchecked Sendable {}
extension TransitRealtime_NyctStopTimeUpdate: @unchecked Sendable {}
