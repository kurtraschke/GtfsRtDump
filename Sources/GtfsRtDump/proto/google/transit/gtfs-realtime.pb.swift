...
// Source: proto/google/transit/gtfs-realtime.proto
//
...
struct TransitRealtime_TripUpdate: SwiftProtobuf.ExtensibleMessage {
  ...
  struct StopTimeUpdate: SwiftProtobuf.ExtensibleMessage {
    ...
    struct StopTimeProperties: SwiftProtobuf.ExtensibleMessage {
      // SwiftProtobuf.Message conformance is added in an extension below. See the
      // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
      // methods supported on all messages.
  ...
  /// NOTE: This message is still experimental, and subject to change. It may be formally adopted in the future.
  struct TripProperties: SwiftProtobuf.ExtensibleMessage {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
struct TransitRealtime_VehiclePosition: SwiftProtobuf.ExtensibleMessage {
  ...
  /// This message/field is still experimental, and subject to change. It may be formally adopted in the future.
  struct CarriageDetails: SwiftProtobuf.ExtensibleMessage {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
struct TransitRealtime_VehicleDescriptor: SwiftProtobuf.ExtensibleMessage {
  ...
  enum WheelchairAccessible: SwiftProtobuf.Enum {
    typealias RawValue = Int
...
extension TransitRealtime_VehicleDescriptor.WheelchairAccessible: CaseIterable {
  // Support synthesized by the compiler.
}
...
///    picked.
/// NOTE: This field is still experimental, and subject to change. It may be formally adopted in the future.
struct TransitRealtime_TranslatedImage: SwiftProtobuf.ExtensibleMessage {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  struct LocalizedImage: SwiftProtobuf.ExtensibleMessage {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
/// NOTE: This message is still experimental, and subject to change. It may be formally adopted in the future.
struct TransitRealtime_Shape: SwiftProtobuf.ExtensibleMessage {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension TransitRealtime_TripUpdate.StopTimeUpdate.StopTimeProperties: @unchecked Sendable {}
extension TransitRealtime_TripUpdate.TripProperties: @unchecked Sendable {}
...
extension TransitRealtime_VehiclePosition.CarriageDetails: @unchecked Sendable {}
...
extension TransitRealtime_Alert.SeverityLevel: @unchecked Sendable {}
...
extension TransitRealtime_VehicleDescriptor.WheelchairAccessible: @unchecked Sendable {}
...
extension TransitRealtime_TranslatedImage: @unchecked Sendable {}
extension TransitRealtime_TranslatedImage.LocalizedImage: @unchecked Sendable {}
extension TransitRealtime_Shape: @unchecked Sendable {}
